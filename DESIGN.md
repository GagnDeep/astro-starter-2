...
- _Note:_ The accent covers at most a tenth of painted pixels. Dark mode surfaces must use the brand hue at low lightness, replacing shadows with a 1px top highlight.

## Typography

**Two Self-Hosted Families (Avoiding banned defaults):**

1. **Display:** A sturdy sans-serif or refined serif (e.g., _Fraunces_ or _Public Sans_, tbd based on self-hosting).
   - Display settings: `clamp(2.75rem, 6vw, 5.5rem)`, `line-height` 0.95-1.05, `tracking` -0.02 to -0.035em.
2. **Body:** A highly readable counterpart (e.g., _Crimson Pro_ or _Chivo_).
