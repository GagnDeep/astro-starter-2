...
post_hero:
  ...
  heading: "Are E-Signatures Legally Binding?"
...
seo:
  page_description: "A deep dive into the ESIGN Act and when a typed name or drawn signature is legally enforceable."
  canonical_url: null
  featured_image: null
