...
<div class="max-w-3xl mx-auto px-4 py-20">
    ...
    <div class="prose max-w-none">
      <p>When searching for <strong>why iframes suck</strong>, developers often find outdated advice from 2012. The web has changed significantly, and how we handle documents needs to evolve.</p>
...
<p>Iframes were not designed for complex, responsive content. They introduce an entirely separate security context and DOM tree. We explore the architectural flaws of the iframe element when handling massive binary streams on constrained mobile devices.</p>
