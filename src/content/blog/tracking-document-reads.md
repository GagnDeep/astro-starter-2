...
<div class="max-w-3xl mx-auto px-4 py-20">
    ...
    <div class="prose max-w-none">
      <p>When searching for <strong>tracking document reads</strong>, developers often find outdated advice from 2012. The web has changed significantly, and how we handle documents needs to evolve.</p>
...
<p>Basic page views do not tell you if a user actually read your document. By leveraging the Intersection Observer API and `postMessage` communication with the iframe, you can track exact page views, dwell time, and completion rates for embedded documents.</p>
