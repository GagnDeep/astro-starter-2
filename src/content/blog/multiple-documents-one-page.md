...
<div class="max-w-3xl mx-auto px-4 py-20">
    ...
    <div class="prose max-w-none">
      <p>When searching for <strong>multiple documents one page</strong>, developers often find outdated advice from 2012. The web has changed significantly, and how we handle documents needs to evolve.</p>
...
<p>Embedding multiple 2MB viewers on a single page will crush your performance score. We discuss lazy loading techniques, Intersection Observers, and how to instantiate viewers only when they enter the viewport to keep the initial payload microscopic.</p>
