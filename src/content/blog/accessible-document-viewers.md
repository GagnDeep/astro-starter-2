...
<div class="max-w-3xl mx-auto px-4 py-20">
    ...
    <div class="prose max-w-none">
      <p>When searching for <strong>accessible document viewers</strong>, developers often find outdated advice from 2012. The web has changed significantly, and how we handle documents needs to evolve.</p>
...
<p>Creating an accessible document viewer means dealing with screen readers like NVDA and VoiceOver. Canvas-based rendering produces an image, not text. Therefore, an invisible DOM layer must be generated over the canvas to provide selectable, readable text runs. This layer must perfectly align with the visual text to allow for natural navigation and high contrast validation.</p>
