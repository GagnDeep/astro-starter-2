...
<div class="max-w-3xl mx-auto px-4 py-20">
    ...
    <div class="prose max-w-none">
      <p>When searching for <strong>how to embed pdf in html</strong>, developers often find outdated advice from 2012. The web has changed significantly, and how we handle documents needs to evolve.</p>
...
<p>Native HTML tags like `<embed>`, `<object>`, and `<iframe>` have wildly varying support across modern browsers. Mobile Safari, in particular, fails to constrain the height of native PDF embeds, leading to infinite scrolling layouts. We outline the modern approach: a lightweight wrapper script.</p>
