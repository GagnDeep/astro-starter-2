...
import UnequalSpanFeatures from "../components/unequal-span-features/unequal-span-features.astro";
...
registerAstroComponent("UnequalSpanFeatures", UnequalSpanFeatures);
